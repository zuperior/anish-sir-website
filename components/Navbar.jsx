...
const Navbar = () => {
  ...
  return (
    <div className=" fixed  top-0 left-1/2 -translate-x-1/2 w-full h-[74px] z-50 will-change-transform">
      <div className="flex-none w-auto h-auto relative opacity-100">
        <div className="w-full   flex justify-between items-center py-[15px] px-[50px] relative">
          ...
          <a href="#" className="flex items-center gap-[10px]">
            <p className="font-[Krona_One] text-[34px] tracking-[-0.08em] leading-[0.9em] text-[#F9432D]">
              ANISH.
            </p>
          </a>
          ...
          <div className="relative">
            ...
            {isMenuOpen && (
              ...
              >
                <div className=" relative w-full h-[50px]  flex flex-col gap-[10px] justify-end items-end">
                ...
                <div className="relative  w-full h-[208px] pr-[15px] flex flex-col gap-0">
                  <Link
                    href="#"
                    className=" relative text-[#FFFFFF]/25  w-[141px] [41px] text-[32px] font-medium leading-[1.3]  tracking-[-0.04em] font-clash-display hover:text-[#FFDAD6]/70"
                  >
                    About ME
                  </Link>
                  <a
                ...
                <div className="relative w-full flex flex-col h-[91px] gap-[25px]">
                  ...
                  <div className="bg-white w-full h-[46px] gap-[10px] py-[15px] px-[25px] rounded-[100px] flex justify-center items-center">
                    <Link
                      href="#"
