...
export const BeYourOwnBossContent = ({ activeSection, onSectionChange }: { activeSection: string; onSectionChange?: (section: string) => void }) => {
    ...
    return (
        <div className="flex-1 bg-black pt-2 border-[#8A1A0E] lg:border-0 rounded-xl lg:rounded-none lg:pt-8 pb-0 lg:pb-20 relative h-full overflow-hidden">
            <h2
                className={`
  ...
  `}
            ...
            <div ref={scrollContainerRef} className="pt-0 pl-4 md:px-8 relative z-10 h-full overflow-y-auto overflow-x-hidden custom-scrollbar" style={{ pointerEvents: "auto" }}>
                {activeSection === "OVERVIEW" && (
                    <div className="space-y-2 pb-5 lg:pb-20">
